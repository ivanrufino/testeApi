<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Visualizar Empresa</a>

    </div>
  </nav>

  <div class="container mt-2">
    <EmpresaForm :codigo="codigo" :empresa="empresa" :sigla="sigla" :razao_social="razao_social"
      @atualizar-codigo="atualizarForm('codigo', $event)" @atualizar-empresa="atualizarForm('empresa', $event)"
      @atualizar-sigla="atualizarForm('sigla', $event)" @atualizar-razao_social="atualizarForm('razao_social', $event)"
...
export default {
  ...
  methods: {
    ...
    atualizarForm(campo, valor) {
      // Atualizando os dados do formulário quando o evento for recebido
