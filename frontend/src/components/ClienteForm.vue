     ...
     <!-- <div class="mb-3 col-md-2">
      ...
      <div class="mb-3 row">
        ...
        <div class="form-check col-md-3">
          <input type="radio" id="tipoPJ" name="tipo" :checked="tipo === 'PJ'" :disabled="modoVisualizacao" @change="atualizarCampo('tipo', 'PJ')">
          <label class="form-check-label" for="tipoPJ">Pessao Juridica</label>
        </div>
        <div class="form-check col-md-3">
          <input type="radio" id="tipoPF" name="tipo" :checked="tipo === 'PF'" :disabled="modoVisualizacao" @change="atualizarCampo('tipo', 'PF')">
      ...
      <div class="mb-3 col-md-6">
        ...
        <input :value="cpf_cnpj" :readonly="modoVisualizacao" @input="atualizarCampo('cpf_cnpj', $event)" class="form-control" id="cpf_cnpj" maxlength=14/>
      </div>
    </div>
