  ...
  <div>
    ...
    <div class="row">
      ...
      <div class="mb-3 col-md-5">
        ...
        <input :value="empresa" :readonly="modoVisualizacao" @input="atualizarCampo('empresa', $event)"
    ...
    <div class="row">
      ...
      <div class="mb-3 col-md-2">
        ...
        <input :value="sigla" :readonly="modoVisualizacao" @input="atualizarCampo('sigla', $event)" class="form-control"
          id="sigla" />
      </div>
