    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <tr v-for="cliente in clientes" :key="cliente.renum">
          ...
          <td><router-link
              :to="{ name: 'visualizarCliente', params: { codigoEmpresa: cliente.empresa, codigo: cliente.codigo } }"
              class="btn btn-info btn-sm me-1">Visualizar</router-link>
            <router-link
              :to="{ name: 'editarCliente', params: { codigoEmpresa: cliente.empresa, codigo: cliente.codigo } }"
